//NOTE: You need a public class StartUp. Create a Restaurant project with the following classes
//and hierarchy:
...
//Price – decimal
//Milliliters – double
//HotBeverage and ColdBeverage are beverages and they accept the following parameters upon
//initialization: string name, decimal price, double milliliters. Reuse the constructor of the
//inherited class.
...
//Price – decimal
//Grams – double
//MainDish, Dessert, and Starter are food. They all accept the following parameters upon
//initialization: string name, decimal price, double grams. Reuse the base class constructor.

...
//"{propertyName} cannot be zero or negative." Use try-catch block to process the error. All properties
//are set by the constructor and when set, they cannot be modified.
